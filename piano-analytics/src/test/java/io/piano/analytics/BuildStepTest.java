...
public class BuildStepTest {
    ...
    public void processTrackEvents() throws JSONException {
        ...
        assertEquals(new JSONObject("{\"context\":[{\"data\":{\"browser_language_local\":\"US\",\"device_screen_diagonal\":3.6,\"app_version\":null,\"connection_type\":\"UNKNOWN\",\"os_version\":\"5.0.2\",\"os_group\":\"android\",\"device_manufacturer\":\"unknown\",\"prop2\":\"val2\",\"prop1\":\"val1\",\"event_collection_version\":\"3.0.0\",\"prop1_1\":\"val1\",\"prop1_2\":\"val2\",\"device_screen_width\":320,\"os\":\"android 5.0.2\",\"device_screen_height\":470,\"device_model\":\"robolectric\",\"app_id\":\"io.piano.analytics.test\",\"browser_language\":\"en\",\"event_collection_platform\":\"android\"}}],\"events\":[{\"data\":{\"ev1prop3_sd_prop1\":\"sd1\",\"page\":\"myPage1\",\"ev1prop2\":2,\"ev1prop1\":\"value 1\",\"ev1prop3_sd_prop2\":\"sd2\"},\"name\":\"event1\"},{\"data\":{\"ev2prop1\":\"test value\",\"page\":\"myPage2\"},\"name\":\"event2\"}]}").toString(),
                built.getBody());
        ...
        assertEquals("https://example.com/test?s=123456&idclient=visitor", built.getUri());
        assertEquals(new JSONObject("{\"context\":[{\"data\":{\"browser_language_local\":\"US\",\"device_screen_diagonal\":3.6,\"app_version\":null,\"connection_type\":\"OFFLINE\",\"os_version\":\"5.0.2\",\"os_group\":\"android\",\"device_manufacturer\":\"unknown\",\"prop2\":\"val2\",\"prop1\":\"val1\",\"event_collection_version\":\"3.0.0\",\"prop1_1\":\"val1\",\"prop1_2\":\"val2\",\"device_screen_width\":320,\"os\":\"android 5.0.2\",\"device_screen_height\":470,\"device_model\":\"robolectric\",\"app_id\":\"io.piano.analytics.test\",\"browser_language\":\"en\",\"event_collection_platform\":\"android\"}}],\"events\":[{\"data\":{\"ev1prop3_sd_prop1\":\"sd1\",\"page\":\"myPage1\",\"ev1prop2\":2,\"ev1prop1\":\"value 1\",\"ev1prop3_sd_prop2\":\"sd2\"},\"name\":\"event1\"},{\"data\":{\"ev2prop1\":\"test value\",\"page\":\"myPage2\"},\"name\":\"event2\"}]}").toString(),
                built.getBody());
    }
