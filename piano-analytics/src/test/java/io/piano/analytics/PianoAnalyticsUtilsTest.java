...
public class PianoAnalyticsUtilsTest {
    ...
    public void getApplicationProperties() {
        ...
        assertNotNull(v);
        assertEquals("io.piano.analytics.test", v.first);
        assertNull(v.second);
    }
    ...
    public void isClassUnavailable() {
        ...
        assertTrue(PianoAnalyticsUtils.isClassUnavailable("io.piano.analytics.UnknownClass"));
        assertFalse(PianoAnalyticsUtils.isClassUnavailable("PianoAnalytics"));
    }
